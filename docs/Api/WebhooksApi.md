...
> \ShipEngineApi\Model\CreateWebhookResponseBody createWebhook($create_webhook_request_body)
...
$apiInstance = new ShipEngineApi\Api\WebhooksApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$create_webhook_request_body = new \ShipEngineApi\Model\CreateWebhookRequestBody(); // \ShipEngineApi\Model\CreateWebhookRequestBody | 
...
------------- | ------------- | ------------- | -------------
 **create_webhook_request_body** | [**\ShipEngineApi\Model\CreateWebhookRequestBody**](../Model/CreateWebhookRequestBody.md)|  |

### Return type

[**\ShipEngineApi\Model\CreateWebhookResponseBody**](../Model/CreateWebhookResponseBody.md)
...
> \ShipEngineApi\Model\GetWebhookByIdResponseBody getWebhookById($webhook_id)
...
[**\ShipEngineApi\Model\GetWebhookByIdResponseBody**](../Model/GetWebhookByIdResponseBody.md)
...
$webhook_id = 'webhook_id_example'; // string | Webhook ID
$update_webhook_request_body = new \ShipEngineApi\Model\UpdateWebhookRequestBody(); // \ShipEngineApi\Model\UpdateWebhookRequestBody | 
...
------------- | ------------- | ------------- | -------------
 **webhook_id** | **string**| Webhook ID |
 **update_webhook_request_body** | [**\ShipEngineApi\Model\UpdateWebhookRequestBody**](../Model/UpdateWebhookRequestBody.md)|  |
