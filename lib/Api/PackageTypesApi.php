...
class PackageTypesApi
{
     ...
     *
     * @param  \ShipEngineApi\Model\CreatePackageTypeRequestBody $create_package_type_request_body create_package_type_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\CreatePackageTypeResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * Create Custom Package Type
     *
     * @param  \ShipEngineApi\Model\CreatePackageTypeRequestBody $create_package_type_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\CreatePackageTypeResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPackageTypeWithHttpInfo($create_package_type_request_body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\CreatePackageTypeResponseBody' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\CreatePackageTypeResponseBody', []),
            ...
            $returnType = '\ShipEngineApi\Model\CreatePackageTypeResponseBody';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\CreatePackageTypeResponseBody',
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\GetPackageTypeByIdResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\GetPackageTypeByIdResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPackageTypeByIdWithHttpInfo($package_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\GetPackageTypeByIdResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\GetPackageTypeByIdResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\GetPackageTypeByIdResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\GetPackageTypeByIdResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\ListPackageTypesResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\ListPackageTypesResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function listPackageTypesWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\ListPackageTypesResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\ListPackageTypesResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\ListPackageTypesResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\ListPackageTypesResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $package_id Package ID (required)
     * @param  \ShipEngineApi\Model\UpdatePackageTypeRequestBody $update_package_type_request_body update_package_type_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     ...
     *
     * @param  string $package_id Package ID (required)
     * @param  \ShipEngineApi\Model\UpdatePackageTypeRequestBody $update_package_type_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of string|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
