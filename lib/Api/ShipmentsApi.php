...
class ShipmentsApi
{
     ...
     * @return string|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of string|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * Create Shipments
     *
     * @param  \ShipEngineApi\Model\CreateShipmentsRequestBody $create_shipments_request_body create_shipments_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\CreateShipmentsResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * Create Shipments
     *
     * @param  \ShipEngineApi\Model\CreateShipmentsRequestBody $create_shipments_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\CreateShipmentsResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function createShipmentsWithHttpInfo($create_shipments_request_body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\CreateShipmentsResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\CreateShipmentsResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\CreateShipmentsResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\CreateShipmentsResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\GetShipmentByExternalIdResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\GetShipmentByExternalIdResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function getShipmentByExternalIdWithHttpInfo($external_shipment_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\GetShipmentByExternalIdResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\GetShipmentByExternalIdResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\GetShipmentByExternalIdResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\GetShipmentByExternalIdResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\GetShipmentByIdResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\GetShipmentByIdResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function getShipmentByIdWithHttpInfo($shipment_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\GetShipmentByIdResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\GetShipmentByIdResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\GetShipmentByIdResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\GetShipmentByIdResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\ListShipmentErrorsResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\ListShipmentErrorsResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function listShipmentErrorsWithHttpInfo($shipment_id, $page = 1, $pagesize = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\ListShipmentErrorsResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\ListShipmentErrorsResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\ListShipmentErrorsResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\ListShipmentErrorsResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\ListShipmentRatesResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\ListShipmentRatesResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function listShipmentRatesWithHttpInfo($shipment_id, $created_at_start = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\ListShipmentRatesResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\ListShipmentRatesResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\ListShipmentRatesResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\ListShipmentRatesResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * List Shipments
     *
     * @param  \ShipEngineApi\Model\ShipmentStatus $shipment_status shipment_status (optional)
     ...
     * @param  \ShipEngineApi\Model\ShipmentsSortBy $sort_by sort_by (optional)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\ListShipmentsResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * List Shipments
     *
     * @param  \ShipEngineApi\Model\ShipmentStatus $shipment_status (optional)
     * @param  string $batch_id Batch ID (optional)
     * @param  string $tag Search for shipments based on the custom tag added to the shipment object (optional)
     * @param  \DateTime $created_at_start Used to create a filter for when a resource was created (ex. A shipment that was created after a certain time) (optional)
     * @param  \DateTime $created_at_end Used to create a filter for when a resource was created, (ex. A shipment that was created before a certain time) (optional)
     ...
     * @param  string $sales_order_id Sales Order ID (optional)
     * @param  SortDir $sort_dir Controls the sort order of the query. (optional)
     * @param  \ShipEngineApi\Model\ShipmentsSortBy $sort_by (optional)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\ListShipmentsResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function listShipmentsWithHttpInfo($shipment_status = null, $batch_id = null, $tag = null, $created_at_start = null, $created_at_end = null, $modified_at_start = null, $modified_at_end = null, $page = 1, $page_size = 25, $sales_order_id = null, $sort_dir = null, $sort_by = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\ListShipmentsResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\ListShipmentsResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\ListShipmentsResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\ListShipmentsResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\ParseShipmentResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function parseShipmentWithHttpInfo($parse_shipment_request_body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\ParseShipmentResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\ParseShipmentResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\ParseShipmentResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\ParseShipmentResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\TagShipmentResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\TagShipmentResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function tagShipmentWithHttpInfo($shipment_id, $tag_name)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\TagShipmentResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\TagShipmentResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\TagShipmentResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\TagShipmentResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $shipment_id Shipment ID (required)
     * @param  \ShipEngineApi\Model\UpdateShipmentRequestBody $update_shipment_request_body update_shipment_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\UpdateShipmentResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     *
     * @param  string $shipment_id Shipment ID (required)
     * @param  \ShipEngineApi\Model\UpdateShipmentRequestBody $update_shipment_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\UpdateShipmentResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateShipmentWithHttpInfo($shipment_id, $update_shipment_request_body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\UpdateShipmentResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\UpdateShipmentResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\UpdateShipmentResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\UpdateShipmentResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
