...
class WebhooksApi
{
     ...
     * Create a Webhook
     *
     * @param  \ShipEngineApi\Model\CreateWebhookRequestBody $create_webhook_request_body create_webhook_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\CreateWebhookResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * Create a Webhook
     *
     * @param  \ShipEngineApi\Model\CreateWebhookRequestBody $create_webhook_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\CreateWebhookResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWebhookWithHttpInfo($create_webhook_request_body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\CreateWebhookResponseBody' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\CreateWebhookResponseBody', []),
            ...
            $returnType = '\ShipEngineApi\Model\CreateWebhookResponseBody';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\CreateWebhookResponseBody',
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\GetWebhookByIdResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\GetWebhookByIdResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWebhookByIdWithHttpInfo($webhook_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\GetWebhookByIdResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\GetWebhookByIdResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\GetWebhookByIdResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\GetWebhookByIdResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return Webhook[]|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of Webhook[]|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     *
     * @param  string $webhook_id Webhook ID (required)
     * @param  \ShipEngineApi\Model\UpdateWebhookRequestBody $update_webhook_request_body update_webhook_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     ...
     *
     * @param  string $webhook_id Webhook ID (required)
     * @param  \ShipEngineApi\Model\UpdateWebhookRequestBody $update_webhook_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of string|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
