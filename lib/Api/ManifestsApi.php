...
class ManifestsApi
{
     ...
     * Create Manifest
     *
     * @param  \ShipEngineApi\Model\CreateManifestRequestBody $create_manifest_request_body create_manifest_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\CreateManifestResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * Create Manifest
     *
     * @param  \ShipEngineApi\Model\CreateManifestRequestBody $create_manifest_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\CreateManifestResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function createManifestWithHttpInfo($create_manifest_request_body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\CreateManifestResponseBody' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\CreateManifestResponseBody', []),
            ...
            $returnType = '\ShipEngineApi\Model\CreateManifestResponseBody';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\CreateManifestResponseBody',
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\GetManifestByIdResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\GetManifestByIdResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function getManifestByIdWithHttpInfo($manifest_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\GetManifestByIdResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\GetManifestByIdResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\GetManifestByIdResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\GetManifestByIdResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\ListManifestsResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\ListManifestsResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function listManifestsWithHttpInfo($warehouse_id = null, $ship_date_start = null, $ship_date_end = null, $created_at_start = null, $created_at_end = null, $carrier_id = null, $page = 1, $page_size = 25, $label_ids = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\ListManifestsResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\ListManifestsResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\ListManifestsResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\ListManifestsResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
