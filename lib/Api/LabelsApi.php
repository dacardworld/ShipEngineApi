...
use ShipEngineApi\ApiException;
use ShipEngineApi\Configuration;
use ShipEngineApi\HeaderSelector;
...
class LabelsApi
{
     ...
     * Purchase Label
     *
     * @param  \ShipEngineApi\Model\CreateLabelRequestBody $create_label_request_body create_label_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\CreateLabelResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * Purchase Label
     *
     * @param  \ShipEngineApi\Model\CreateLabelRequestBody $create_label_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\CreateLabelResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function createLabelWithHttpInfo($create_label_request_body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\CreateLabelResponseBody' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\CreateLabelResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\ShipEngineApi\Model\ErrorResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\ErrorResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\ShipEngineApi\Model\CreateLabelResponseBody';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\CreateLabelResponseBody',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\ErrorResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \ShipEngineApi\Model\CreateLabelFromRateRequestBody $create_label_from_rate_request_body create_label_from_rate_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\CreateLabelFromRateResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     *
     * @param  string $rate_id Rate ID (required)
     * @param  \ShipEngineApi\Model\CreateLabelFromRateRequestBody $create_label_from_rate_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\CreateLabelFromRateResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function createLabelFromRateWithHttpInfo($rate_id, $create_label_from_rate_request_body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\CreateLabelFromRateResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\CreateLabelFromRateResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\CreateLabelFromRateResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\CreateLabelFromRateResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \ShipEngineApi\Model\CreateLabelFromShipmentRequestBody $create_label_from_shipment_request_body create_label_from_shipment_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\CreateLabelFromShipmentResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     *
     * @param  string $shipment_id Shipment ID (required)
     * @param  \ShipEngineApi\Model\CreateLabelFromShipmentRequestBody $create_label_from_shipment_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\CreateLabelFromShipmentResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function createLabelFromShipmentWithHttpInfo($shipment_id, $create_label_from_shipment_request_body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\CreateLabelFromShipmentResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\CreateLabelFromShipmentResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\CreateLabelFromShipmentResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\CreateLabelFromShipmentResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \ShipEngineApi\Model\CreateReturnLabelRequestBody $create_return_label_request_body create_return_label_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\CreateReturnLabelResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     *
     * @param  string $label_id Label ID (required)
     * @param  \ShipEngineApi\Model\CreateReturnLabelRequestBody $create_return_label_request_body (required)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\CreateReturnLabelResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function createReturnLabelWithHttpInfo($label_id, $create_return_label_request_body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\CreateReturnLabelResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\CreateReturnLabelResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\CreateReturnLabelResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\CreateReturnLabelResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \ShipEngineApi\Model\LabelDownloadType $label_download_type label_download_type (optional)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\GetLabelByExternalShipmentIdResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * @param  \ShipEngineApi\Model\LabelDownloadType $label_download_type (optional)
     *
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\GetLabelByExternalShipmentIdResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function getLabelByExternalShipmentIdWithHttpInfo($external_shipment_id, $label_download_type = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\GetLabelByExternalShipmentIdResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\GetLabelByExternalShipmentIdResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\GetLabelByExternalShipmentIdResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\GetLabelByExternalShipmentIdResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\GetLabelByIdResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\GetLabelByIdResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function getLabelByIdWithHttpInfo($label_id, $label_download_type = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\GetLabelByIdResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\GetLabelByIdResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\GetLabelByIdResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\GetLabelByIdResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\GetTrackingLogFromLabelResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\GetTrackingLogFromLabelResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTrackingLogFromLabelWithHttpInfo($label_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\GetTrackingLogFromLabelResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\GetTrackingLogFromLabelResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\GetTrackingLogFromLabelResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\GetTrackingLogFromLabelResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * List labels
     *
     * @param  \ShipEngineApi\Model\LabelStatus $label_status Only return labels that are currently in the specified status (optional)
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\ListLabelsResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\ListLabelsResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function listLabelsWithHttpInfo($label_status = null, $service_code = null, $carrier_id = null, $tracking_number = null, $batch_id = null, $rate_id = null, $shipment_id = null, $warehouse_id = null, $created_at_start = null, $created_at_end = null, $page = 1, $page_size = 25, $sort_dir = null, $sort_by = 'created_at')
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\ListLabelsResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\ListLabelsResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\ListLabelsResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\ListLabelsResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ShipEngineApi\Model\VoidLabelResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody
     */
     ...
     * @throws \ShipEngineApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ShipEngineApi\Model\VoidLabelResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody|\ShipEngineApi\Model\ErrorResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function voidLabelWithHttpInfo($label_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ShipEngineApi\Model\VoidLabelResponseBody' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ShipEngineApi\Model\VoidLabelResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ShipEngineApi\Model\VoidLabelResponseBody';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ShipEngineApi\Model\VoidLabelResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
