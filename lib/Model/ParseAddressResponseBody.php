...
class ParseAddressResponseBody implements ModelInterface, ArrayAccess
{
     ...
     * Sets entities
     *
     * @param \ShipEngineApi\Model\RecognizedEntity[] $entities All of the entities that were recognized in the text. An \"entity\" is a single piece of data, such as a city, a postal code, or an address line.  Each entity includes the original text and the parsed value.
     *
     * @return $this
     */
