...
class Label implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'packages' => '\ShipEngineApi\Model\Package[]'
    ];
     ...
     * Gets packages
     *
     * @return \ShipEngineApi\Model\Package[]|null
     */
     ...
     * Sets packages
     *
     * @param \ShipEngineApi\Model\Package[]|null $packages The label's package(s).  > **Note:** Some carriers only allow one package per label.  If you attempt to create a multi-package label for a carrier that doesn't allow it, an error will be returned.
     *
     * @return $this
     */
