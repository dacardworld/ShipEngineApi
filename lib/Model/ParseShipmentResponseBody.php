...
class ParseShipmentResponseBody implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'entities' => '\ShipEngineApi\Model\RecognizedEntity[]'
    ];
     ...
     * Gets entities
     *
     * @return \ShipEngineApi\Model\RecognizedEntity[]
     */
     ...
     * Sets entities
     *
     * @param \ShipEngineApi\Model\RecognizedEntity[] $entities All of the entities that were recognized in the text. An \"entity\" is a single piece of data, such as a city, a postal code, a carrier name, or a package weight.  Each entity includes the original text and the parsed value.
     *
     * @return $this
     */
