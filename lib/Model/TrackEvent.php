...
class TrackEvent implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['state_province']) < 0)) {
            $invalidProperties[] = "invalid value for 'state_province', the character length must be bigger than or equal to 0.";
        }
    ...
    public function setStateProvince($state_province)
    {
        ...
        if ((mb_strlen($state_province) < 0)) {
            throw new \InvalidArgumentException('invalid length for $state_province when calling TrackEvent., must be bigger than or equal to 0.');
        }
